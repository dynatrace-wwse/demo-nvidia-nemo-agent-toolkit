...
```bash
@sergiohinojosa ➜ /workspaces/demo-agentic-ai-with-nvidia (main) $ deployGhdocs 
INFO    -  Cleaning site directory
INFO    -  Building documentation to directory: /workspaces/demo-agentic-ai-with-nvidia/site
...
INFO    -  Copying '/workspaces/demo-agentic-ai-with-nvidia/site' to 'gh-pages' branch and pushing to GitHub.
...
To https://github.com/dynatrace-wwse/demo-agentic-ai-with-nvidia
   bca482c..db42f7f  gh-pages -> gh-pages
INFO    -  Your documentation should shortly be available at: https://dynatrace-wwse.github.io/demo-agentic-ai-with-nvidia/
